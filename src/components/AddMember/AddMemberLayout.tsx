...
export default function AddMember() {
  ...
  return (
    <div className="max-w-[1300px] w-full mx-auto mt-10">
      ...
      <h1 className="text-dark text-4xl font-bold mt-10">Add team member</h1>

      <div className="flex flex-row items-center justify-between">
        <div className="flex flex-col gap-y-5 border border-border bg-white rounded-xl w-[280px] py-5 px-7 mt-10">
